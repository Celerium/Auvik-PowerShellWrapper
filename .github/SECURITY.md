...
The "AuvikAPI" team and community take all security bugs in "AuvikAPI" seriously. Thank you for improving the security of "AuvikAPI". We appreciate your efforts and responsible disclosure and will make every effort to acknowledge your contributions.
...
- "AuvikAPI" will confirm the problem and determine the affected versions.
- "AuvikAPI" will audit code to find any potential similar problems.
- "AuvikAPI" will prepare fixes for all releases still under maintenance. These fixes will be released as fast as possible.
