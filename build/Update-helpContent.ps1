...
.PARAMETER helpDocsPath
    ...
    Reference:
        Yes - "Auvik-PowerShellWrapper\docs"
        NO  - "Auvik-PowerShellWrapper\AuvikAPI\docs"

    Example: "C:\Celerium\Projects\Auvik-PowerShellWrapper\docs"

.PARAMETER csvFilePath
    Location where the tracking CSV is located including the CSV file name

    The tracking CSV should be located in "Auvik-PowerShellWrapper\docs"
    Reference:
        Yes - "Auvik-PowerShellWrapper\docs\Endpoints.csv"
        NO  - "Auvik-PowerShellWrapper\AuvikAPI\docs\Endpoints.csv"

    Example: "C:\Celerium\Projects\Auvik-PowerShellWrapper\docs\Endpoints.csv"

.PARAMETER githubPageUri
    Base url of the modules github pages

    Example: "https://celerium.github.io/Auvik-PowerShellWrapper"
...
.EXAMPLE
    .\Update-helpContent.ps1
        -moduleName AuvikAPI
        -helpDocsPath "C:\Celerium\Projects\Auvik-PowerShellWrapper\docs"
        -csvFilePath "C:\Celerium\Projects\Auvik-PowerShellWrapper\docs\Endpoints.csv"
        -githubPageUri "https://celerium.github.io/Auvik-PowerShellWrapper"
...
$downloadLink = "$githubPageUri/docs/cab"
    ...
    $moduleDescription = 'This PowerShell module acts as a wrapper for the Auvik API.'
