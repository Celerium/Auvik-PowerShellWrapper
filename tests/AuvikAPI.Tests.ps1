...
.SYNOPSIS
    Pester tests for the AuvikAPI module manifest file.
...
Describe "Testing the [ $buildTarget ] version of [ $moduleName ] with [ $pester_TestName ]" {
    ...
    Context "[ $moduleName.psd1 ] general manifest data" {
        ...
        It "Manifest [ RootModule ] has valid data" {
            $Module.RootModule | Should -Be 'AuvikAPI.psm1'
        }
        ...
        It "Manifest [ GUID ] has valid data" {
            $Module.GUID | Should -Be 'a558b301-ea3a-47e9-a204-eb559821ddf1'
        }
        ...
        It "Manifest [ Copyright ] has valid data" {
            $Module.Copyright | Should -Be 'https://github.com/Celerium/Auvik-PowerShellWrapper/blob/main/LICENSE'
        }
        ...
        It "Manifest [ NestedModules ] has valid data" {
            switch ($buildTarget){
                ...
                'notBuilt'  { ($Module.NestedModules.Name).Count | Should -Be 36 }
            }
        }

        It "Manifest [ FunctionsToExport ] has valid data" {
            ($Module.ExportedCommands).Count | Should -Be 38
        }
        ...
        It "Manifest [ AliasesToExport ] has alias" {
            switch ($buildTarget){
                'built'     { ($Module.ExportedAliases).Count |  Should -Be 3 }
                'notBuilt'  { $Module.ExportedAliases |  Should -Not -BeNullOrEmpty }
            }
        }

        It "Manifest [ Tags ] has valid data" {
            $Module.PrivateData.PSData.Tags | Should -Contain 'Auvik'
        ...
        It "Manifest [ LicenseUri ] has valid data" {
            $Module.LicenseUri | Should -Be 'https://github.com/Celerium/Auvik-PowerShellWrapper/blob/main/LICENSE'
        }

        It "Manifest [ ProjectUri ] has valid data" {
            $Module.ProjectUri  | Should -Be 'https://github.com/Celerium/Auvik-PowerShellWrapper'
        }

        It "Manifest [ IconUri ] has valid data" {
            $Module.IconUri  | Should -Be 'https://raw.githubusercontent.com/Celerium/Auvik-PowerShellWrapper/main/.github/images/Celerium_PoSHGallery_AuvikAPI.png'
        }

        It "Manifest [ ReleaseNotes ] has valid data" {
            $Module.ReleaseNotes  | Should -Be 'https://github.com/Celerium/Auvik-PowerShellWrapper/blob/main/README.md'
        }
