...
Context "[ $commandName ] testing functions" {
    ...
    It "With parameter -base_uri <value> should return what was inputted" {
        Add-AuvikBaseURI -base_uri 'https://celerium.org'
        Get-AuvikBaseURI | Should -Be 'https://celerium.org'
    }

    It "With parameter -data_center should return the default URIs" {

        $uris = 'au1', 'ca1', 'eu1', 'eu2', 'us1', 'us2', 'us3', 'us4'
        foreach ($uri in $uris) {
            Add-AuvikBaseURI -data_center $uri
    ...
    It "With invalid parameter value -data_center Space should return an error" {
        Remove-AuvikBaseURI
        {Add-AuvikBaseURI -data_center Space} | Should -Throw
    }
